---
title: Customizing Provider Model List in Hermes Chat for Deployment
description: >-
  Learn how to customize the model list in Hermes Chat for deployment with the
...
Hermes Chat supports customizing the model list during deployment. This configuration is done in the environment for each [model provider](/docs/self-hosting/environment-variables/model-provider).
