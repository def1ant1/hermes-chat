...
description: >-
  Learn how to import and export configuration settings for Hermes Chat via URL.
...
Hermes Chat support import settings from external URL to quickly set up Hermes Chat configuration.
...
```plaintext
https://hermes.chat/?settings=<settings object in JSON format>
https://hermes.chat/?settings={"keyVaults":{"openai":{"apiKey":"user-key","baseURL":"https://your-proxy.com/v1"}}}
```
...
<Callout type={'warning'}>
  Hermes Chat does not verify the correctness of the settings parameters in the URL, nor provide
