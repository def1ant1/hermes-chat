...
```bash
curl -O https://raw.githubusercontent.com/hermeslabs/lobe-chat/HEAD/docker-compose/production/grafana/docker-compose.yml
curl -O https://raw.githubusercontent.com/hermeslabs/lobe-chat/HEAD/docker-compose/production/grafana/.env.example
mv .env.example .env
```
