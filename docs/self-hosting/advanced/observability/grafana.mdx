...
description: >-
  Monitor and analyze your Hermes Chat instance using Grafana dashboards,
...
Hermes Chat supports advanced observability for self-hosted deployments using open-source tools:
...
This guide will help you set up and use these tools to monitor your Hermes Chat instance.
...
```bash
curl -O https://raw.githubusercontent.com/hermeslabs/hermes-chat/HEAD/docker-compose/production/grafana/docker-compose.yml
curl -O https://raw.githubusercontent.com/hermeslabs/hermes-chat/HEAD/docker-compose/production/grafana/.env.example
mv .env.example .env
```
...
2. Start the stack with the correct profile:
   ...
   This will launch Grafana, Prometheus, Tempo, and the otel-collector alongside Hermes Chat with Casdoor, Minio, and other advanced services.
...
- Verify Prometheus and Tempo are scraping and receiving data from Hermes Chat and otel-collector.

## See Also

- [Langfuse Observability](https://hermes.chat/docs/self-hosting/advanced/observability/langfuse)
- [Self-Hosting Overview](https://hermes.chat/docs/self-hosting/start)
