---
title: Configuration of Microsoft Entra ID Authentication Service for Hermes Chat
description: >-
  Learn how to configure Microsoft Entra ID Authentication Service for Hermes
  Chat, create applications, add users, and set up environment variables for
...
<Steps>
  ...
  <Image alt="App Register" inStep src="https://github.com/hermeslabs/hermes-chat/assets/13883964/4f9d83bd-b3fc-4abc-bcf4-ccbad65c219d" />
  ...
  <Image alt="App Overview" inStep src="https://github.com/hermeslabs/hermes-chat/assets/13883964/48a0b702-05bd-4ce4-a007-a8ad00a36e5a" />
  ...
  <Image alt="Create App Client Secret" inStep src="https://github.com/hermeslabs/hermes-chat/assets/13883964/c9d66fa0-158c-4bd3-a1fa-969e638259d2" />
  ...
  Go back to the "Microsoft Entra ID" interface, enter "Users", click on "New user", fill in the user information, and click on "Create" to create a user for using Hermes Chat.
