---
title: 在 Hermes Chat 中配置 Authentik 身份验证服务
description: >-
  学习如何在 Hermes Chat 中配置 Authentik 身份验证服务，包括创建提供程序、配置环境变量和部署 Hermes
  Chat。详细步骤和必要环境变量设置。
tags:
  - Authentik
  - 身份验证
...
<Steps>
  ...
  <Image alt="创建 Authentik 提供程序" inStep src="https://github.com/hermeslabs/hermes-chat/assets/67304509/4244634e-5f68-48d5-aac0-e5f4b06d1c4b" />
...
<Callout type={'info'}>
  部署成功后，用户将可以使用 Authentik 中配置的用户通过身份认证并使用 Hermes Chat。
</Callout>
