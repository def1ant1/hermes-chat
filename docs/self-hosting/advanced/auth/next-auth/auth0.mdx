---
title: Configure Auth0 Identity Verification Service for Hermes Chat
description: >-
  Learn how to configure Auth0 Identity Verification Service for Hermes Chat for
...
<Steps>
  ...
  <Image alt="Create Auth0 Application S1" inStep src="https://github.com/hermeslabs/hermes-chat/assets/30863298/f068190f-0027-4d3b-8667-d632e43d5a86" />

  Fill in the application name you want to display to the organization users, choose any application type, and click "Create".

  <Image alt="Create Auth0 Application S2" inStep src="https://github.com/hermeslabs/hermes-chat/assets/30863298/3e0082df-9b6f-46f3-b67f-bdc79e1eb2cc" />
  ...
  <Image alt="Create Auth0 Application S3" inStep src="https://github.com/hermeslabs/hermes-chat/assets/30863298/df4cea85-616a-46f5-b2de-42725d9b82a6" />
  ...
  <Image alt="Create Auth0 Application S4" inStep src="https://github.com/hermeslabs/hermes-chat/assets/30863298/62fbd09f-a69a-4460-949b-0f6285fa65b9" />
  ...
  Click on the "Users Management" in the left navigation bar to enter the user management interface, where you can create users for your organization to log in to Hermes Chat.

  <Image alt="Add Users" inStep src="https://github.com/hermeslabs/hermes-chat/assets/30863298/0beda150-d0b6-43cf-a9f1-fce928b83a96" />
...
<Callout>
  After successful deployment, users will be able to authenticate and use Hermes Chat using the users
  configured in Auth0.
</Callout>
...
<Image alt="Connecting to an Existing Single Sign-On Service" src="https://github.com/hermeslabs/hermes-chat/assets/30863298/9891347e-a338-4aa9-8714-f16c8dbcfcec" />
...
<Image alt="Configuring Social Login" src="https://github.com/hermeslabs/hermes-chat/assets/30863298/880749a6-5ba4-4e20-a968-b583a54de7fa" />

<Callout type={'warning'}>
  Configuring social login services by default allows anyone to authenticate, which may lead to
  Hermes Chat being abused by external users.
</Callout>
