---
title: Configure Okta Identity Verification Service for Hermes Chat
description: >-
  Learn how to configure Okta Identity Verification Service for Hermes Chat for
...
<Steps>
  ...
  | ---------------------- | ------------------------------------------------------------------------------------------------------------ | --------------------------------------------- |
  | App Integration Name   | The Application Name your users will see                                                                     | Hermes Chat Instance                          |
  ...
  Click on the "Assignments" in the top navigation bar to enter the user management interface, where you can create or assign users in your organization to log in to Hermes Chat.
