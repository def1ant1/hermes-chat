---
title: Integrating Data Analytics Services in Hermes Chat for User Usage Analysis
description: >-
  Learn how to integrate free/open-source data analytics services in Hermes Chat
  to collect user usage data efficiently.
tags:
  - Hermes Chat
  - data analytics
  - user usage analysis
...
To better help analyze the usage of Hermes Chat users, we have integrated several free/open-source data analytics services in Hermes Chat for collecting user usage data, which you can enable as needed.
