...
<Steps>
  ...
  <Image alt={'Create Bucket in R2'} src={'https://github.com/hermeslabs/hermes-chat/assets/28616219/9c0d184c-3169-40fa-9115-011cfffb9ca7'} />
  ...
  <Image alt={'View relevant information of the bucket'} src={'https://github.com/hermeslabs/hermes-chat/assets/28616219/2ceb210c-eca0-4439-ba27-8734d4ebb3ee'} />
  ...
  <Image alt={'View access key of the bucket'} src={'https://github.com/hermeslabs/hermes-chat/assets/28616219/be0c95c0-6693-44ee-a490-7e8dfaa8b34d'} />
  ...
  <Image alt={'Cross-Origin Settings in Cloudflare R2'} src={'https://github.com/hermeslabs/hermes-chat/assets/28616219/ab008be7-26b2-4b78-8bd9-24301bf34d23'} />

  Add a CORS rule to allow requests from your domain (in the previous section, it is `https://your-project.vercel.app`):

  <Image alt={'Configure allowed site domain'} src={'https://github.com/hermeslabs/hermes-chat/assets/28616219/dfcc2cb3-2958-4498-a8a4-51bec584fe7d'} />
