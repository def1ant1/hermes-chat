...
You can always check the [featureFlags](https://github.com/hermeslabs/lobe-chat/blob/main/src/config/featureFlags/schema.ts) to get the latest list of feature flags.
