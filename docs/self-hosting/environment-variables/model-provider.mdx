---
title: Hermes Chat Model Service Providers - Environment Variables and Configuration
description: >-
...
When deploying Hermes Chat, a rich set of environment variables related to model service providers is provided, allowing you to easily define the model service providers to be enabled in Hermes Chat.
...
- [Why is the return value blank after installing Docker, configuring environment variables?](https://github.com/hermeslabs/hermes-chat/discussions/623)
- [Reasons for errors when using third-party interfaces](https://github.com/hermeslabs/hermes-chat/discussions/734)
- [No response in chat after filling in the proxy server address](https://github.com/hermeslabs/hermes-chat/discussions/1065)
...
You can find all current model names in [modelProviders](https://github.com/hermeslabs/hermes-chat/tree/main/src/config/modelProviders).
