---
title: Customize Hermes Chat Deployment with Environment Variables
description: >-
  Learn about the common environment variables used to customize Hermes Chat
...
Hermes Chat provides some additional configuration options during deployment, which can be customized using environment variables.
...
- Type: Optional
- Description: Add a password to access the Hermes Chat service. You can set a long password to prevent brute force attacks.
- Default: -
...
- Type: Optional
- Description: Used to configure the default settings for the Hermes Chat default agent. It supports various data types and structures, including key-value pairs, nested fields, array values, and more.
- Default: -
- Example: `'model=gpt-4-1106-preview;params.max_tokens=300;plugins=search-engine,lobe-image-designer'`

The `DEFAULT_AGENT_CONFIG` is used to configure the default settings for the Hermes Chat default agent. It supports various data types and structures, including key-value pairs, nested fields, array values, and more. The table below provides detailed information on the configuration options, examples, and corresponding explanations for the `DEFAULT_AGENT_CONFIG` environment variable:
...
- [\[RFC\] 022 - Default Assistant Parameters Configuration via Environment Variables](https://github.com/hermeslabs/hermes-chat/discussions/913)

### `SYSTEM_AGENT`

- Type: Optional
- Description: Used to configure models and providers for Hermes Chat system agents (such as topic generation, translation, etc.).
- Default value: `-`
...
- Type: Optional
- Description: Used to control Hermes Chat's feature functionalities. Supports multiple feature flags, using `+` to add a feature and `-` to disable a feature. Separate multiple feature flags with a comma `,` and enclose the entire value in quotes `"` to avoid parsing errors.
- Default: `-`
...
- Type: Optional
- Description: Index address of the Hermes Chat plugin market. If you have deployed the plugin market service on your own, you can use this variable to override the default plugin market address.
- Default: `https://chat-plugins.hermes.chat`
...
- Type: Optional
- Description: Index address of the Hermes Chat assistant market. If you have deployed the assistant market service on your own, you can use this variable to override the default market address.
- Default: `https://chat-agents.hermes.chat`
