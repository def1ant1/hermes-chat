...
<Steps>
  ...
  <Callout type="important">
    ...
    详情请见 [https://github.com/hermeslabs/lobe-chat/discussions/5986](https://github.com/hermeslabs/lobe-chat/discussions/5986)
  </Callout>
...
该章节主要为你介绍在不同的网络环境下自定义部署 Hermes Chat 服务必须要修改的配置。在开始前，你可以先下载 [Docker Compose 配置文件](https://raw.githubusercontent.com/hermeslabs/lobe-chat/HEAD/docker-compose/local/docker-compose.yml) 以及 [环境变量配置文件](https://raw.githubusercontent.com/hermeslabs/lobe-chat/HEAD/docker-compose/local/.env.zh-CN.example)。

```sh
curl -O https://raw.githubusercontent.com/hermeslabs/lobe-chat/HEAD/docker-compose/local/docker-compose.yml
curl -O https://raw.githubusercontent.com/hermeslabs/lobe-chat/HEAD/docker-compose/local/.env.zh-CN.example
