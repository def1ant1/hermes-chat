---
title: Deploy Hermes Chat with Database on RepoCloud
description: >-
  Learn how to deploy Hermes Chat on RepoCloud with ease, including database,
...
# Deploying Hermes Chat Database Edition with RepoCloud

If you want to deploy Hermes Chat Database Edition on RepoCloud, you can follow the steps below:
