---
title: >-
  Troubleshooting `OPENAI_PROXY_URL` in Hermes Chat Configuration for Empty
  Response
description: >-
  Learn how to troubleshoot and resolve the issue of receiving an empty response
  after configuring the Hermes Chat `OPENAI_PROXY_URL` environment variable.
tags:
  - OPENAI_PROXY_URL
...
- [Why is the return value blank after configuring environment variables in Docker?](https://github.com/hermeslabs/hermes-chat/discussions/623)
- [Reasons for errors when using third-party interfaces](https://github.com/hermeslabs/hermes-chat/discussions/734)
- [No response when the proxy server address is filled in for chat](https://github.com/hermeslabs/hermes-chat/discussions/1065)
