---
title: 通过 Docker 部署 Hermes Chat
description: >-
  学习如何使用 Docker 部署 Hermes Chat 服务，包括安装 Docker
...
我们提供了 [Docker 镜像][docker-release-link]，供你在自己的私有设备上部署 Hermes Chat 服务。
...
<Steps>
  ...
  <Callout type="warning">
    ...
    stolen!!!](https://github.com/hermeslabs/hermes-chat/issues/1123) 这样的情况
  </Callout>
