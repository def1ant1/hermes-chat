---
title: 通过 宝塔面板Docker应用商店 部署 Hermes Chat
description: >-
  学习如何使用 宝塔面板Docker应用 部署 Hermes Chat 服务，包括安装 Docker
...
3. 安装完成后在`Docker-应用商店-AI/大模型`中找到 `Hermes Chat`，点击`安装` ![安装](https://github.com/user-attachments/assets/db59a5e7-32ed-49d7-a791-8f8ee6618c01)
...
- 如果您填写域名，请在浏览器输入您的域名访问，如`http://demo.hermes-chat`，即可访问 `Hermes Chat` 页面。
- 请在浏览器地址栏中输入域名访问 `http://<宝塔面板IP>:3210`，即可访问 `Hermes Chat` 页面。 ![Hermes Chat](https://github.com/user-attachments/assets/808f8849-5738-4a60-8ccf-01e300b0dc88)
