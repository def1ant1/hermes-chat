...
如果想在 Zeabur 上部署 Hermes Chat，可以按照以下步骤进行操作：
...
# 使用 Zeabur 将 Hermes Chat 部署为无服务器函数

> **注意：** 仍然存在关于 [Zeabur 上 next.js 的中间件和重写问题](https://github.com/hermeslabs/hermes-chat/pull/2775?notification_referrer_id=NT_kwDOAdi2DrQxMDkyODQ4MDc2NTozMDk3OTU5OA#issuecomment-2146713899)，请自担风险！

由于 Zeabur 并未官方支持免费用户部署容器化服务，您可能希望将 Hermes Chat 部署为无服务器函数服务。要在 Zeabur 上将 Hermes Chat 部署为无服务器函数服务，您可以按照以下步骤操作：
...
<Steps>
  ...
  ### 将您的 Hermes Chat 分支链接到刚创建的 Zeabur 服务。
