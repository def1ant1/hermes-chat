---
title: Deploy Hermes Chat on Zeabur
description: >-
...
# Deploy Hermes Chat with Zeabur

If you want to deploy Hermes Chat on Zeabur, you can follow the steps below:
...
# Deploy Hermes Chat with Zeabur as serverless function

> Note: There are still issues with [middlewares and rewrites of next.js on Zeabur](https://github.com/hermeslabs/hermes-chat/pull/2775?notification_referrer_id=NT_kwDOAdi2DrQxMDkyODQ4MDc2NTozMDk3OTU5OA#issuecomment-2146713899), use at your own risk!

Since Zeabur does NOT officially support FREE users deploy containerized service, you may wish to deploy Hermes Chat as a serverless function service. To deploy Hermes Chat as a serverless function service on Zeabur, you can follow the steps below:
...
<Steps>
  ...
  ### Link your fork of Hermes Chat to the just created Zeabur service.
