---
title: Deploy Hermes Chat on Sealos
description: >-
...
# Deploy Hermes Chat with Sealos

If you want to deploy Hermes Chat on Sealos, you can follow the steps below:
...
[deploy-link]: https://template.usw.sealos.io/deploy?templateName=hermes-chat
