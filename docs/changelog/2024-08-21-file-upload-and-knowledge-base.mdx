---
title: >-
  Hermes Chat Launches Knowledge Base Feature: A New Experience in Intelligent
  File Management and Dialogue
description: >-
  Hermes Chat introduces a brand new knowledge base feature that supports all
  types of file management, intelligent vectorization, and file dialogue, making
...
We are excited to announce that the highly anticipated Hermes Chat knowledge base feature is now officially launched! 🎉 This feature is now available in both the open-source version and the Cloud version (hermes-chat.com).
...
All features are open-sourced on the [GitHub repository](https://github.com/hermeslabs/hermes-chat). We invite you to visit [Hermes Chat Cloud](http://hermes-chat.com) to experience the full functionality.
