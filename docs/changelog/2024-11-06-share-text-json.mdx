---
title: Hermes Chat Supports Sharing Conversations in Text Format (Markdown/JSON)
description: >-
  Hermes Chat v1.28.0 introduces support for exporting conversations in Markdown
