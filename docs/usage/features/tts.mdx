---
title: Hermes Chat support Speech Synthesis and Recognition (TTS & STT)
description: >-
  Experience seamless Text-to-Speech (TTS) and Speech-to-Text (STT) technologies
  in Hermes Chat. Choose from a variety of high-quality voices for personalized
  communication. Learn more about Hermes TTS toolkit @hermeslabs/tts.
tags:
  - Hermes Chat
  - TTS
  - STT
...
<Callout type={'info'}>
  During the implementation of the TTS feature in Hermes Chat, we found that there was no good frontend
