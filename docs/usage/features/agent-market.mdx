...
> reliably detect Hermes-managed inventory. Any remaining `lobehub` references
> indicate stale metadata and should be reported through the support queue.

<Callout type={'tip'}>
  By [🤖/🏪 submitting agents](https://github.com/hermeslabs/lobe-chat-agents), you can easily submit
