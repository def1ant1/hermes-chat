...
description: >-
  Discover Hermes Chat's file upload and knowledge base features for enhanced
  user experience.
tags:
  - File Upload
  - Knowledge Base
...
<Callout type={'tip'}>
  Learn more on [📘 Hermes Chat Knowledge Base Launch — From Now On, Every Step
  Counts](https://hermes.chat/blog/knowledge-base)
</Callout>
