---
title: Hermes Chat 移动设备适配 - 提升用户移动体验
description: Hermes Chat针对移动设备进行优化设计，版本迭代以实现更流畅直观的交互。欢迎通过GitHub Issues或Pull Requests提供反馈。
tags:
  - Hermes Chat
  - 移动设备适配
  - 用户体验
...
Hermes Chat 针对移动设备进行了一系列的优化设计，以提升用户的移动体验。
