---
title: Hermes Chat support Progressive Web Apps (PWA)
description: >-
  Discover how Hermes Chat utilizes Progressive Web App (PWA) technology to
  provide a seamless and near-native app experience on both desktop and mobile
  devices. Learn how to install Hermes Chat as a desktop app for enhanced
  convenience.
tags:
  - Progressive Web App
  - PWA
...
<Callout type={'tip'}>
  The default installed Hermes Chat PWA icon has a black background, you can use <kbd>cmd</kbd> +  <kbd>i</kbd> to paste the following image to replace it with a white background.
</Callout>

<Image alt={'PWA White Icon'} borderless cover src={'https://github.com/hermeslabs/hermes-chat/assets/36695271/16ce82cb-49be-4d4d-ac86-4403a1536917'} />
