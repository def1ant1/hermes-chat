...
At the same time, we are also planning to support more model service providers, such as Replicate and Perplexity, to further enrich our service provider library. If you would like Hermes Chat to support your favorite service provider, feel free to join our [community discussion](https://github.com/hermeslabs/lobe-chat/discussions/6157).

## Local Model Support

<Image alt={'Local Model Support'} borderless src={'https://github.com/hermeslabs/lobe-chat/assets/28616219/ca9a21bc-ea6c-4c90-bf4a-fa53b4fb2b5c'} />
