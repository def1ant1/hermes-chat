---
title: Using iFLYTEK Spark in Hermes Chat
description: Learn how to integrate and utilize iFLYTEK's Spark model APIs in Hermes Chat.
tags:
  - Hermes Chat
  - iFLYTEK
  - Spark
...
# Using iFLYTEK Spark in Hermes Chat
...
This guide will instruct you on how to use iFLYTEK Spark in Hermes Chat.
...
<Steps>
  ...
  ### Step 2: Configure iFLYTEK Spark in Hermes Chat

  - Access the `Settings` menu in Hermes Chat
...
Now you can use the models provided by iFLYTEK Spark for conversations in Hermes Chat.
