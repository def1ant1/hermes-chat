---
title: Using Vertex AI API Key in Hermes Chat
description: >-
  Learn how to configure and use Vertex AI models in Hermes Chat, get an API
...
# Using Vertex AI in Hermes Chat

<Image alt={'Using Vertex AI in Hermes Chat'} cover src={'https://github.com/user-attachments/assets/638dcd7c-2bff-4adb-bade-da2aaef872bf'} />
...
This document will guide you on how to connect Vertex AI models in Hermes Chat:
...
<Steps>
  ...
  ### Step 3: Configure Vertex AI in Hermes Chat

  - Visit the `App Settings` and then the `AI Service Provider` interface in Hermes Chat.
...
Now you can use the models provided by Vertex AI for conversations in Hermes Chat.
