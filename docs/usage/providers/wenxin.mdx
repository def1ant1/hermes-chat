---
title: Using Wenxin Qianfan in Hermes Chat
description: >-
...
# Using Wenxin Qianfan in Hermes Chat
...
This article will guide you on how to use Wenxin Qianfan in Hermes Chat.
...
<Steps>
  ...
  ### Step 2: Configure Wenxin Qianfan in Hermes Chat

  - Go to the `Settings` page of Hermes Chat
...
You can now use the models provided by Wenxin Qianfan for conversations in Hermes Chat.
