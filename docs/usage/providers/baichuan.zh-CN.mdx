---
title: 在 Hermes Chat 中使用百川 API Key
description: 学习如何在 Hermes Chat 中配置和使用百川的API Key，以便开始对话和交互。
tags:
  - Hermes Chat
  - 百川
  - 百川智能
...
<Image alt={'在 Hermes Chat 中使用百川'} cover src={'https://github.com/user-attachments/assets/d961f2af-47b0-4806-8288-b1e8f7ee8a47'} />

本文将指导你如何在 Hermes Chat 中使用百川：
...
至此你已经可以在 Hermes Chat 中使用百川提供的模型进行对话了。
