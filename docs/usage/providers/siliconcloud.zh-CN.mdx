---
title: 在 Hermes Chat 中使用 SiliconCloud
description: 学习如何在 Hermes Chat 中配置和使用 SiliconCloud 的API Key，以便开始对话和交互。
tags:
  - Hermes Chat
  - SiliconCloud
  - API密钥
...
# 在 Hermes Chat 中使用 SiliconCloud
...
本文将指导你如何在 Hermes Chat 中使用 SiliconCloud。
...
<Steps>
  ...
  ### 步骤二：在 Hermes Chat 中配置 SiliconCloud
...
至此你已经可以在 Hermes Chat 中使用 SiliconCloud 提供的模型进行对话了。
