---
title: 在 Hermes Chat 中使用 LM Studio
description: 学习如何配置和使用 LM Studio，并在 Hermes Chat 中 通过 LM Studio 运行 AI 模型进行对话。
tags:
  - Hermes Chat
  - LM Studio
  - 开源模型
...
# 在 Hermes Chat 中使用 LM Studio

<Image alt={'在 Hermes Chat 中使用 LM Studio'} cover src={'https://github.com/user-attachments/assets/cc1f6146-8063-4a4d-947a-7fd6b9133c0c'} />
...
本文档将指导你如何在 Hermes Chat 中使用 LM Studio:
...
<Steps>
  ...
  ### 步骤五：在 Hermes Chat 中使用 LM Studio
...
至此你已经可以在 Hermes Chat 中使用 LM Studio 运行的模型进行对话了。
