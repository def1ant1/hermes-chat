---
title: 在 Hermes Chat 中使用 Vercel AI Gateway
description: 了解如何在 Hermes Chat 中集成和使用 Vercel AI Gateway 的统一 API
tags:
  - Hermes Chat
  - Vercel AI Gateway
  - API 密钥
...
<Steps>
  ...
  ### 第二步：在 Hermes Chat 中配置 Vercel AI Gateway

  - 进入 Hermes Chat 的 `设置` 页面
...
至此，您可以在 Hermes Chat 中使用 Vercel AI Gateway 提供的模型开始聊天了。
