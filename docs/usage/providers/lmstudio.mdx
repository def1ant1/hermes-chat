...
# Using LM Studio in Hermes Chat

<Image alt={'Using LM Studio in Hermes Chat'} cover src={'https://github.com/user-attachments/assets/cc1f6146-8063-4a4d-947a-7fd6b9133c0c'} />
...
This document will guide you on how to use LM Studio in Hermes Chat:
...
<Steps>
  ...
  ### Step 5: Use LM Studio in Hermes Chat

  - Visit the `AI Service Provider` interface in Hermes Chat's `Application Settings`.
...
Now you can use the model running in LM Studio in Hermes Chat for conversations.
