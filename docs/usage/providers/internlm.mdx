---
title: Using InternLM in Hermes Chat
description: >-
  Learn how to configure and use SenseNova's API Key in Hermes Chat to start
...
This article will guide you on how to use InternLM in Hermes Chat.
...
<Steps>
  ...
  ### Step 2: Configure InternLM in Hermes Chat
...
You are now ready to engage in conversations using the models provided by InternLM in Hermes Chat.
