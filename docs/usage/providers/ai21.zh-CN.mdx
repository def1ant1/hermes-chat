---
title: 在 Hermes Chat 中使用 AI21 Labs
description: 学习如何在 Hermes Chat 中配置和使用 AI21 Labs 的API Key，以便开始对话和交互。
tags:
  - Hermes Chat
  - AI21 Labs
  - API密钥
...
本文将指导你如何在 Hermes Chat 中使用 AI21 Labs。
...
<Steps>
  ...
  ### 步骤二：在 Hermes Chat 中配置 AI21 Labs
...
至此你已经可以在 Hermes Chat 中使用 AI21 Labs 提供的模型进行对话了。
