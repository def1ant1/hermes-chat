---
title: 在 Hermes Chat 中使用腾讯混元
description: 学习如何在 Hermes Chat 中配置和使用腾讯混元的API Key，以便开始对话和交互。
tags:
  - Hermes Chat
  - 腾讯混元
  - API密钥
...
至此你已经可以在 Hermes Chat 中使用腾讯混元提供的模型进行对话了。
