---
title: Using 302.AI in Hermes Chat
description: >-
  Learn how to configure and use 302.AI's API Key in Hermes Chat to start
...
This article will guide you on how to use 302.AI in Hermes Chat.
...
<Steps>
  ...
  ### Step 2: Configure 302.AI in Hermes Chat

  - Access Hermes Chat's `Settings` interface
...
Now you can use 302.AI's models for conversations in Hermes Chat.
