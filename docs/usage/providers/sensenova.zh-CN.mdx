---
title: 在 Hermes Chat 中使用商汤日日新
description: 学习如何在 Hermes Chat 中配置和使用商汤日日新的 API Key，以便开始对话和交互。
tags:
  - Hermes Chat
  - 商汤日日新
  - API密钥
...
本文将指导你如何在 Hermes Chat 中使用商汤日日新。
...
至此你已经可以在 Hermes Chat 中使用商汤日日新提供的模型进行对话了。
