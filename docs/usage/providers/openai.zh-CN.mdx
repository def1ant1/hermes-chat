...
<Image alt={'在 Hermes Chat 中使用 OpenAI'} cover src={'https://github.com/hermeslabs/lobe-chat/assets/17870709/c9e5eafc-ca22-496b-a88d-cc0ae53bf720'} />
...
'https://github-production-user-asset-6210df.s3.amazonaws.com/28616219/296255167-f2745f2b-f083-4ba8-bc78-9b558e0002de.png'
  ...
  <Image alt={'填入 API 密钥'} inStep src={'https://github.com/hermeslabs/lobe-chat/assets/17870709/3f31bc33-509f-4ad2-ba81-280c2a6ec5fa'} />

  - 填入获得的 API 密钥
  - 为你的 AI 助手选择一个 OpenAI 的模型即可开始对话

  <Image alt={'选择 OpenAI 模型并开始对话'} inStep src={'https://github.com/hermeslabs/lobe-chat/assets/17870709/ff7ebacf-27f0-42d7-810b-00314499a084'} />
