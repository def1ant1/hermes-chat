---
title: Using Azure AI API Key in Hermes Chat
description: >-
  Learn how to configure and use Azure AI models in Hermes Chat, get the API
...
# Using Azure AI in Hermes Chat

<Image alt={'Using Azure AI in Hermes Chat'} cover src={'https://github.com/user-attachments/assets/81d0349a-44fe-4dfc-bbc4-8e9a1e09567d'} />
...
This document will guide you on how to integrate Azure AI models into Hermes Chat:
...
<Steps>
  ...
  ### Step 3: Configure Azure AI in Hermes Chat

  - Visit the `App Settings` and `AI Service Provider` interface in Hermes Chat.
...
Now you can use the models provided by Azure AI in Hermes Chat for conversations.
