---
title: Using OpenAI API Key in Hermes Chat
description: >-
  Learn how to integrate OpenAI API Key in Hermes Chat. Support GPT-4o /
...
# Using OpenAI in Hermes Chat

<Image alt={'Using OpenAI in Hermes Chat'} cover src={'https://github.com/hermeslabs/hermes-chat/assets/17870709/c9e5eafc-ca22-496b-a88d-cc0ae53bf720'} />

This document will guide you on how to use [OpenAI](https://openai.com/) in Hermes Chat:
...
'https://github-production-user-asset-6210df.s3.amazonaws.com/28616219/296255167-f2745f2b-f083-4ba8-bc78-9b558e0002de.png'
  ...
  <Image alt={'Enter API Key'} inStep src={'https://github.com/hermeslabs/hermes-chat/assets/17870709/3f31bc33-509f-4ad2-ba81-280c2a6ec5fa'} />

  - Enter the obtained API Key
  - Choose an OpenAI model for your AI assistant to start the conversation

  <Image alt={'Select OpenAI model and start conversation'} inStep src={'https://github.com/hermeslabs/hermes-chat/assets/17870709/ff7ebacf-27f0-42d7-810b-00314499a084'} />
...
You can now engage in conversations using the models provided by OpenAI in Hermes Chat.
