---
title: 在 Hermes Chat 中使用 Vertex AI API Key
description: 学习如何在 Hermes Chat 中配置和使用 Vertex AI 模型，获取 API 密钥并开始对话。
tags:
  - Hermes Chat
  - Vertex AI
  - API密钥
...
# 在 Hermes Chat 中使用 Vertex AI

<Image alt={'在 Hermes Chat 中使用 Vertex AI '} cover src={'https://github.com/user-attachments/assets/638dcd7c-2bff-4adb-bade-da2aaef872bf'} />
...
本文档将指导你如何在 Hermes Chat 中接入 Vertex AI 的模型:
...
<Steps>
  ...
  ### 步骤三：在 Hermes Chat 中配置 Vertex AI
...
至此你已经可以在 Hermes Chat 中使用 Vertex AI 提供的模型进行对话了。
