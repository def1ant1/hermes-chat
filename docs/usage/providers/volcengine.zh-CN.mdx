---
title: 在 Hermes Chat 中使用火山引擎 API Key
description: 学习如何在 Hermes Chat 中配置和使用火山引擎 AI 模型，获取 API 密钥并开始对话。
tags:
  - Hermes Chat
  - 火山引擎
  - 豆包
...
# 在 Hermes Chat 中使用火山引擎

<Image alt={'在 Hermes Chat 中使用火山引擎'} cover src={'https://github.com/user-attachments/assets/b9da065e-f964-44f2-8260-59e182be2729'} />

[火山引擎](https://www.volcengine.com/)是字节跳动旗下的云服务平台，通过 "火山方舟" 提供大型语言模型 (LLM) 服务，支持多个主流模型如百川智能、Mobvoi 等。

本文档将指导你如何在 Hermes Chat 中使用火山引擎:
...
至此你已经可以在 Hermes Chat 中使用火山引擎提供的模型进行对话了。
