---
title: Using Vercel AI Gateway in Hermes Chat
description: >-
  Learn how to integrate and utilize Vercel AI Gateway's unified API in Hermes
  Chat.
tags:
  - Hermes Chat
  - Vercel AI Gateway
...
# Using Vercel AI Gateway in Hermes Chat
...
This article will guide you on how to use Vercel AI Gateway in Hermes Chat.
...
<Steps>
  ...
  ### Step 2: Configure Vercel AI Gateway in Hermes Chat

  - Go to the `Settings` page in Hermes Chat
...
At this point, you can start chatting using the models provided by Vercel AI Gateway in Hermes Chat.
