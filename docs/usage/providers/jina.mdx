---
title: Using Jina AI API Key in Hermes Chat
description: >-
  Learn how to configure and use Jina AI models in Hermes Chat, obtain an API
  key, and start conversations.
tags:
  - Hermes Chat
  - Jina AI
  - API Key
...
# Using Jina AI in Hermes Chat

<Image alt={'Using Jina AI in Hermes Chat'} cover src={'https://github.com/user-attachments/assets/840442b1-bf56-4a5f-9700-b3608b16a8a5'} />
...
This document will guide you on how to use Jina AI in Hermes Chat:
...
<Steps>
  ...
  ### Step 2: Configure Jina AI in Hermes Chat

  - Visit Hermes Chat's `Application Settings` interface.
...
Now you can use the models provided by Jina AI in Hermes Chat to have conversations.
