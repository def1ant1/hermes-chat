---
title: Using vLLM API Key in Hermes Chat
description: >-
  Learn how to configure and use the vLLM language model in Hermes Chat, obtain
...
# Using vLLM in Hermes Chat

<Image alt={'Using vLLM in Hermes Chat'} cover src={'https://github.com/user-attachments/assets/1d77cca4-7363-4a46-9ad5-10604e111d7c'} />
...
This document will guide you on how to use vLLM in Hermes Chat:
...
<Steps>
  ...
  ### Step 4: Configure vLLM in Hermes Chat

  - Access the `Application Settings` interface of Hermes Chat.
...
Now you can use the models provided by vLLM in Hermes Chat to have conversations.
