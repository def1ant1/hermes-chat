...
<Image alt={'Using Together AI in Hermes Chat'} cover src={'https://github.com/hermeslabs/lobe-chat/assets/34400653/497e3b20-57ca-4963-b6f4-897c9710c16e'} />
...
<Steps>
  ...
  <Image alt={'Obtaining Zhipu AI API Key'} inStep src={'https://github.com/hermeslabs/lobe-chat/assets/34400653/6d6f2bc5-1407-471d-95a8-fb03193edbdb'} />
  ...
  <Image alt={'Enter Zhipu AI API Key in Hermes Chat'} inStep src={'https://github.com/hermeslabs/lobe-chat/assets/34400653/2afffe79-1d37-423c-9363-f09605d5e640'} />

  - Open Zhipu AI and enter the obtained API key
  - Choose a Zhipu AI model for your assistant to start the conversation

  <Image alt={'Select and use Zhipu AI model'} inStep src={'https://github.com/hermeslabs/lobe-chat/assets/34400653/b83da559-73d1-4734-87d5-5e22955a9da2'} />
