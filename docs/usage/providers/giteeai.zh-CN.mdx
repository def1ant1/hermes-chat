---
title: 在 Hermes Chat 中使用 Gitee AI
description: 学习如何在 Hermes Chat 中配置和使用 Gitee AI 的 API Key，以便开始对话和交互。
tags:
  - Hermes Chat
  - Gitee AI
  - API密钥
...
本文将指导你如何在 Hermes Chat 中使用 Gitee AI。
...
<Steps>
  ...
  ### 步骤二：在 Hermes Chat 中配置 Gitee AI
...
至此你已经可以在 Hermes Chat 中使用 Gitee AI 提供的模型进行对话了。
