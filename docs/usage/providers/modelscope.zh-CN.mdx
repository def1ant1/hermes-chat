...
description: 学习如何在 Hermes Chat 中配置和使用 ModelScope 提供商
tags:
  - ModelScope
---
...
ModelScope（魔塔社区）是阿里巴巴的开源模型社区，提供各种 AI 模型的访问服务。本指南将帮助您在 Hermes Chat 中设置 ModelScope 提供商。
...
- 查看我们的 [GitHub Issues](https://github.com/hermeslabs/hermes-chat/issues)
- 加入我们的社区讨论
