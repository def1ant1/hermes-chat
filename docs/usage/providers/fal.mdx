---
title: Using Fal API Key in Hermes Chat
description: >-
  Learn how to integrate Fal API Key in Hermes Chat for AI image and video
  generation using cutting-edge models like FLUX, Kling, and more.
tags:
  - Fal AI
  - Image Generation
  - Video Generation
...
# Using Fal in Hermes Chat

<Image alt={'Using Fal in Hermes Chat'} cover src={'https://hub-apac-1.lobeobjects.space/docs/f253e749baaa2ccac498014178f93091.png'} />

[Fal.ai](https://fal.ai/) is a lightning-fast inference platform specialized in AI media generation, hosting state-of-the-art models for image and video creation including FLUX, Kling, HiDream, and other cutting-edge generative models. This document will guide you on how to use Fal in Hermes Chat:
...
'https://hub-apac-1.lobeobjects.space/docs/499a447e98dcc79407d56495d0305e2a.png'
  ...
  ### Step 2: Configure Fal in Hermes Chat
...
You can now use Fal's advanced image and video generation models directly within Hermes Chat to create stunning visual content.
