---
title: 在 Hermes Chat 中使用360智脑
description: 学习如何在 Hermes Chat 中配置和使用360智脑的API Key，以便开始对话和交互。
tags:
  - Hermes Chat
  - 360智脑
  - API密钥
...
本文将指导你如何在 Hermes Chat 中使用 360 智脑。
...
至此你已经可以在 Hermes Chat 中使用 360 智脑提供的模型进行对话了。
