...
description: Learn how to configure and use ModelScope provider in Hermes Chat
tags:
  - ModelScope
---
...
ModelScope (魔塔社区) is Alibaba's open-source model community that provides access to various AI models. This guide will help you set up the ModelScope provider in Hermes Chat.
...
3. **Get API Token**
   ...
   - Copy the token for use in Hermes Chat
...
For Hermes Chat integration issues:

- Check our [GitHub Issues](https://github.com/hermeslabs/hermes-chat/issues)
