---
title: Using Taichu API Key in Hermes Chat
description: >-
  Learn how to integrate Taichu AI into Hermes Chat for enhanced conversational
...
# Using Taichu in Hermes Chat

<Image alt={'Using Taichu in Hermes Chat'} cover src={'https://github.com/user-attachments/assets/9cb27b68-f2ac-4ff9-8f97-d96314b1af03'} />

This article will guide you on how to use Taichu in Hermes Chat:
...
<Steps>
  ...
  ### Step 2: Configure Taichu in Hermes Chat
...
Now you can start conversing with the models provided by Taichu in Hermes Chat.
