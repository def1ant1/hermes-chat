---
title: Using Novita AI API Key in Hermes Chat
description: >-
  Learn how to integrate Novita AI's language model APIs into Hermes Chat.
  Follow the steps to register, create an Novita AI API key, configure settings,
  and chat with our various AI models.
tags:
  - Novita AI
  - Llama3
  - Mistral
...
# Using Novita AI in Hermes Chat

<Image alt={'Using Novita AI in Hermes Chat'} cover src={'https://github.com/user-attachments/assets/b2b36128-6a43-4a1f-9c08-99fe73fb565f'} />
...
This document will guide you on how to integrate Novita AI in Hermes Chat:
...
<Steps>
  ...
  ### Step 3: Configure Novita AI in Hermes Chat

  - Visit the `Settings` interface in Hermes Chat
  - Find the setting for `novita.ai` under `AI Service Provider`

  <Image alt={'Enter Novita AI API key in Hermes Chat'} inStep src={'https://github.com/user-attachments/assets/00c02637-873e-4e7e-9dc3-a95085b16dd7'} />
...
You can now engage in conversations using the models provided by Novita AI in Hermes Chat.
