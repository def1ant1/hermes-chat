---
title: 在 Hermes Chat 中使用 Jina AI API Key
description: 学习如何在 Hermes Chat 中配置和使用 Jina AI 模型，获取 API 密钥并开始对话。
tags:
  - Hermes Chat
  - Jina AI
  - API密钥
...
# 在 Hermes Chat 中使用 Jina AI

<Image alt={'在 Hermes Chat 中使用 Jina AI'} cover src={'https://github.com/user-attachments/assets/840442b1-bf56-4a5f-9700-b3608b16a8a5'} />

[Jina AI](https://jina.ai/) 是一家成立于 2020 年的开源神经搜索公司，专注于利用深度学习技术处理多模态数据，提供高效的信息检索解决方案，支持文本、图像、视频等多种数据类型的搜索。

本文档将指导你如何在 Hermes Chat 中使用 Jina AI:
...
至此你已经可以在 Hermes Chat 中使用 Jina AI 提供的模型进行对话了。
