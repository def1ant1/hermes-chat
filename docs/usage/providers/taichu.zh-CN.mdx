---
title: 在 Hermes Chat 中使用紫东太初 API Key
description: 学习如何在 Hermes Chat 中配置和使用紫东太初的API Key，以便开始对话和交互。
tags:
  - Hermes Chat
  - 太初
  - 紫东太初
...
# 在 Hermes Chat 中使用紫东太初

<Image alt={'在 Hermes Chat 中使用太初'} cover src={'https://github.com/user-attachments/assets/9cb27b68-f2ac-4ff9-8f97-d96314b1af03'} />

本文将指导你如何在 Hermes Chat 中使用紫东太初：
...
至此你已经可以在 Hermes Chat 中使用紫东太初提供的模型进行对话了。
