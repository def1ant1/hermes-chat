---
title: Using Nvidia NIM API Key in Hermes Chat
description: >-
  Learn how to configure and use Nvidia NIM AI models in Hermes Chat, obtain an
...
# Using Nvidia NIM in Hermes Chat

<Image alt={'Using Nvidia NIM in Hermes Chat'} cover src={'https://github.com/user-attachments/assets/539349dd-2c16-4f42-b525-cca74e113541'} />
...
This document will guide you on how to access and use AI models provided by Nvidia NIM in Hermes Chat:
...
<Steps>
  ...
  ### Step 2: Configure Nvidia NIM in Hermes Chat

  - Visit the `Application Settings` -> `AI Service Provider` interface in Hermes Chat.
...
Now you can use the models provided by Nvidia NIM to have conversations in Hermes Chat.
