---
title: Using Cloudflare Workers AI in Hermes Chat
description: >-
  Learn how to integrate and utilize Cloudflare Workers AI Models in Hermes
  Chat.
tags:
  - Hermes Chat
  - Cloudflare
...
# Using Cloudflare Workers AI in Hermes Chat
...
This document will guide you on how to use Cloudflare Workers AI in Hermes Chat:
...
<Steps>
  ...
  ### Step 2: Configure Cloudflare Workers AI in Hermes Chat
...
At this point, you can start conversing with the model provided by Cloudflare Workers AI in Hermes Chat.
