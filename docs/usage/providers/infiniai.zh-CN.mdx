---
title: 在 Hermes Chat 中使用无问芯穹
description: 学习如何在 Hermes Chat 中配置和使用无问芯穹的 API Key，实现 AI 对话交互。
tags:
  - Hermes Chat
  - 无问芯穹
  - API密钥
...
<Steps>
  ...
  ### 步骤二：配置 Hermes Chat 模型服务

  - 打开 Hermes Chat 进入「设置」界面
