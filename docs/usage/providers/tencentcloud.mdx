---
title: Using Tencent Cloud API Key in Hermes Chat
description: >-
  Learn how to configure and use Tencent Cloud AI models in Hermes Chat, obtain
  an API key, and start a conversation.
tags:
  - Hermes Chat
  - Tencent Cloud
  - API Key
...
# Using Tencent Cloud in Hermes Chat

<Image alt={'Using Tencent Cloud in Hermes Chat'} cover src={'https://github.com/user-attachments/assets/aa91ca54-65fc-4e33-8c76-999f0a5d2bee'} />
...
This document will guide you on how to connect Tencent Cloud's AI models in Hermes Chat:
...
<Steps>
  ...
  ### Step 2: Configure Tencent Cloud in Hermes Chat

  - Visit the `Application Settings` and `AI Service Provider` interface of Hermes Chat.
...
You can now use the models provided by Tencent Cloud in Hermes Chat to have conversations.
