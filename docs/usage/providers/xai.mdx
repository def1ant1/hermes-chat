---
title: Using xAI in Hermes Chat
description: >-
  Learn how to configure and use xAI's API Key in Hermes Chat to start
...
This article will guide you on how to use xAI in Hermes Chat.
...
<Steps>
  ...
  ### Step 2: Configure xAI in Hermes Chat

  - Go to the `Settings` menu in Hermes Chat
...
You are now ready to engage in conversations using the models provided by xAI in Hermes Chat.
