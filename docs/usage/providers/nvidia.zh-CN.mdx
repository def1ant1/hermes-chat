---
title: 在 Hermes Chat 中使用 Nvidia NIM API Key
description: 学习如何在 Hermes Chat 中配置和使用 Nvidia NIM AI 模型，获取 API 密钥并开始对话。
tags:
  - Hermes Chat
  - Nvidia NIM
  - API密钥
...
# 在 Hermes Chat 中使用 Nvidia NIM

<Image alt={'在 Hermes Chat 中使用 Nvidia NIM'} cover src={'https://github.com/user-attachments/assets/539349dd-2c16-4f42-b525-cca74e113541'} />
...
本文档将指导你如何在 Hermes Chat 中接入并使用 Nvidia NIM 提供的 AI 模型:
...
<Steps>
  ...
  ### 步骤二：在 Hermes Chat 中配置 Nvidia NIM

  - 访问 Hermes Chat 的 `应用设置` 的 `AI 服务供应商` 界面
...
至此你已经可以在 Hermes Chat 中使用 Nvidia NIM 提供的模型进行对话了。
