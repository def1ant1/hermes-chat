---
title: 在 Hermes Chat 中使用 Azure AI API Key
description: 学习如何在 Hermes Chat 中配置和使用 Azure AI 模型，获取 API 密钥并开始对话。
tags:
  - Hermes Chat
  - Azure AI
  - API密钥
...
# 在 Hermes Chat 中使用 Azure AI

<Image alt={'在 Hermes Chat 中使用 Azure AI '} cover src={'https://github.com/user-attachments/assets/81d0349a-44fe-4dfc-bbc4-8e9a1e09567d'} />
...
本文档将指导你如何在 Hermes Chat 中接入 Azure AI 的模型:
...
<Steps>
  ...
  ### 步骤三：在 Hermes Chat 中配置 Azure AI
...
至此你已经可以在 Hermes Chat 中使用 Azure AI 提供的模型进行对话了。
