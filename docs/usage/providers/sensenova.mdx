---
title: Using SenseNova in Hermes Chat
description: >-
...
# Using SenseNova in Hermes Chat
...
This article will guide you on how to use SenseNova in Hermes Chat.
...
<Steps>
  ...
  ### Step 2: Configure SenseNova in Hermes Chat

  - Access the `Settings` interface on Hermes Chat.
...
You can now have conversations using the models provided by SenseNova in Hermes Chat.
