---
title: Using SambaNova API Key in Hermes Chat
description: >-
  Learn how to configure and use SambaNova models in Hermes Chat, obtain an API
...
# Using SambaNova in Hermes Chat

<Image alt={'Using SambaNova in Hermes Chat'} cover src={'https://github.com/user-attachments/assets/1028aa1a-6c19-4191-b28a-2020e5637155'} />
...
This document will guide you on how to use SambaNova in Hermes Chat:
...
<Steps>
  ...
  ### Step 2: Configure SambaNova in Hermes Chat
...
Now you can use the models provided by SambaNova in Hermes Chat to conduct conversations.
