---
title: Using GitHub Models in Hermes Chat
description: Learn how to integrate and utilize GitHub Models in Hermes Chat.
tags:
  - Hermes Chat
  - GitHub
  - GitHub Models
...
# Using GitHub Models in Hermes Chat
...
This article will guide you on how to use GitHub Models in Hermes Chat.
...
<Steps>
  ...
  ### Step 2: Configure GitHub Models in Hermes Chat

  - Navigate to the `Settings` interface in Hermes Chat.
...
You are now ready to use the models provided by GitHub for conversations within Hermes Chat.
