---
title: Using Black Forest Labs API Key in Hermes Chat
description: >-
  Learn how to integrate Black Forest Labs API Key in Hermes Chat for AI image
  generation using advanced models and high-quality output.
tags:
  - Black Forest Labs
  - Image Generation
  - API Key
...
# Using Black Forest Labs in Hermes Chat

<Image alt={'Using Black Forest Labs in Hermes Chat'} cover src={'https://hub-apac-1.lobeobjects.space/docs/c7274a5b037227f042ad7558f535b5ea.png'} />

[Black Forest Labs](https://bfl.ai/) is currently the world's top-tier AI image generation research lab, having developed the FLUX series of high-quality image generation models and the FLUX Kontext series of image editing models. This document will guide you on how to use Black Forest Labs in Hermes Chat:
...
'https://hub-apac-1.lobeobjects.space/docs/33143deb04f2a0cdb2fd543ff8161633.png'
  ...
  ### Step 2: Configure Black Forest Labs in Hermes Chat

  - Visit the `Settings` page in Hermes Chat.
...
You can now use Black Forest Labs's advanced image generation models directly within Hermes Chat to create stunning visual content.
