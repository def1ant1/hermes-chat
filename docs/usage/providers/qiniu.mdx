---
title: Using Qiniu API Key in Hermes Chat
description: >-
  Learn how to integrate and utilize powerful language models developed by Qiniu
  into Hermes Chat for various tasks. Follow the steps to obtain an API key and
  configure it for seamless interaction.
tags:
  - API key
  - Web UI
  - 七牛
...
# Using Qiniu's AI Models in Hermes Chat

<Image alt={"Using Qiniu's AI Models in Hermes Chat"} cover src={'https://github.com/user-attachments/assets/3ad2655e-dd20-4534-bf6d-080b3677df86'} />
...
This document will guide you on how to use Qiniu's AI Models in Hermes Chat:
...
<Steps>
  ...
  - Method 1: Using Console
    ...
    2. [Go to the console to obtain your API Key](https://portal.qiniu.com/ai-inference/api-key)
       <Image alt={'Obtain your API Key'} inStep src={'https://static.sufy.com/hermeslabs/439040511-a014769f-262c-4ee4-a727-2c3c45111574.png'} />
  ...
  ### Step 2: Configure Qiniu's AI Model Service in Hermes Chat

  - Visit the `Settings` interface in Hermes Chat
  - Find the setting for `Qiniu` under `AI Service Provider`

  <Image alt={'Enter API key'} inStep src={'https://static.sufy.com/hermeslabs/439047682-40bd5ec0-c2fe-4397-9ae1-f6d0b9e55287.png'} />

  - Open Qiniu and enter the obtained API key.
  - Choose a Qiniu's model for your AI assistant to start the conversation.

  <Image alt={"Select a Qiniu's model and start conversation"} inStep src={'https://static.sufy.com/hermeslabs/439048211-eadae11f-86e8-4a8d-944d-2f984e257356.png'} />
...
You can now engage in conversations using the models provided by Qiniu in Hermes Chat.
