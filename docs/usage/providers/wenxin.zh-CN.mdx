---
title: 在 Hermes Chat 中使用文心千帆
description: 学习如何在 Hermes Chat 中配置和使用文心千帆的API Key，以便开始对话和交互。
tags:
  - Hermes Chat
  - 百度
  - 文心千帆
...
至此你已经可以在 Hermes Chat 中使用文心千帆提供的模型进行对话了。
