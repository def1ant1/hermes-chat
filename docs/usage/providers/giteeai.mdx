---
title: Using Gitee AI in Hermes Chat
description: >-
  Learn how to configure and use Gitee AI's API Key in Hermes Chat to start
...
This article will guide you on how to use Gitee AI in Hermes Chat.
...
<Steps>
  ...
  ### Step 2: Configure Gitee AI in Hermes Chat

  - Access the `Settings` page in Hermes Chat
...
Now you can start having conversations using the models provided by Gitee AI in Hermes Chat!
