---
title: Using the Volcano Engine API Key in Hermes Chat
description: >-
  Learn how to configure and use the Volcano Engine AI model in Hermes Chat,
  obtain API keys, and start conversations.
tags:
  - Hermes Chat
  - Volcengine
  - Doubao
...
# Using Volcengine in Hermes Chat

<Image alt={'Using Volcengine in Hermes Chat'} cover src={'https://github.com/user-attachments/assets/b9da065e-f964-44f2-8260-59e182be2729'} />
...
This document will guide you on how to use Volcengine in Hermes Chat:
...
<Steps>
  ...
  ### Step 2: Configure Volcengine in Hermes Chat

  - Navigate to the `Application Settings` page in Hermes Chat and select `AI Service Providers`.
...
You can now use the models provided by Volcengine for conversations in Hermes Chat.
