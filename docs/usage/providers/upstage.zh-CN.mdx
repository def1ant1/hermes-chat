---
title: 在 Hermes Chat 中使用 Upstage
description: 学习如何在 Hermes Chat 中配置和使用 Upstage 的API Key，以便开始对话和交互。
tags:
  - Hermes Chat
  - Upstage
  - API密钥
...
本文将指导你如何在 Hermes Chat 中使用 Upstage。
...
至此你已经可以在 Hermes Chat 中使用 Upstage 提供的模型进行对话了。
