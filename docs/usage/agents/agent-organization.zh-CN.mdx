---
title: Hermes Chat 助手组织指南 - 提升助手管理效率
description: 了解如何通过分组、搜索和固定功能更好地组织 Hermes Chat 的 AI 助手，提升助手管理效率和定位效率。
tags:
  - Hermes Chat
  - AI 助手
  - 助手组织
...
Hermes Chat 提供了丰富的 AI 助手资源，用户可以通过助手市场方便地添加各类助手，为 AI 应用提供了广泛的应用场景。

当你添加了大量助手后，在列表中寻找特定助手可能会变得比较困难。Hermes Chat 提供了`搜索`、`分组`和`固定`功能，帮助您更好地组织助手，提升定位效率。

## 助手分组

首先 Hermes Chat 的 AI 助手支持以分组的方式进行组织。你可以将同类型的助手归类到一起，并通过折叠和展开分组的方式方便地查询所需助手。
