---
title: Efficiently Organize Your AI Assistants with Hermes Chat
description: >-
  Learn how to use Hermes Chat's grouping, search, and pinning functions to
...
Hermes Chat provides a rich variety of AI assistant resources. Users can easily add various assistants through the assistant market, offering a wide range of application scenarios for AI applications.

When you have added a large number of assistants, finding a specific assistant in the list may become challenging. Hermes Chat provides `search`, `grouping`, and `pinning` functions to help you better organize assistants and improve efficiency in locating them.

## Assistant Grouping

Firstly, Hermes Chat's AI assistants support organization through grouping. You can categorize assistants of the same type together and easily search for the required assistants by collapsing and expanding groups.
