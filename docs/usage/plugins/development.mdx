...
1. **Plugin Index**: Used to display basic information about the plugin, including the plugin name, description, author, version, and a link to the plugin manifest. The official plugin index can be found at [lobe-chat-plugins](https://github.com/hermeslabs/lobe-chat-plugins). If you want to publish a plugin to the official plugin marketplace, you need to [submit a PR](https://github.com/hermeslabs/lobe-chat-plugins/pulls) to this repository.
...
[`@hermeslabs/chat-plugins-gateway`](https://github.com/hermeslabs/chat-plugins-gateway) contains the implementation of the plugin gateway in Hermes Chat [here](https://github.com/hermeslabs/lobe-chat/blob/main/src/pages/api/plugins.api.ts). You can use this package directly to create a gateway, allowing Hermes Chat to access the local plugin service.
...
```tsx
import { fetchPluginMessage } from '@hermeslabs/chat-plugin-sdk';
...
If you want more people to use your plugin, feel free to [submit it for listing](https://github.com/hermeslabs/lobe-chat-plugins) on the plugin marketplace.

[![][submit-plugin-shield]][submit-plugin-url]

### Plugin Shield

[![lobe-chat-plugin](https://img.shields.io/badge/%F0%9F%A4%AF%20%26%20%F0%9F%A7%A9%20Hermes%20Labs-Plugin-95f3d9?labelColor=black\&style=flat-square)](https://github.com/hermeslabs/lobe-chat-plugins)
...
- **🏪 lobe-chat-plugins**: [https://github.com/hermeslabs/lobe-chat-plugins](https://github.com/hermeslabs/lobe-chat-plugins)

[fetch-plugin-message-url]: https://github.com/hermeslabs/chat-plugin-template
[lobe-chat-plugin-template-url]: https://github.com/hermeslabs/chat-plugin-template
...
[submit-plugin-url]: https://github.com/hermeslabs/lobe-chat-plugins
