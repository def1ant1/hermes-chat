...
description: >-
  使用 Hermes Chat 测试 Google Gemini 系列模型（Gemini 1.5 Pro / Gemini 1.5 Flash）
...
<Video src="https://github.com/hermeslabs/hermes-chat/assets/28616219/a5a35431-2a15-4e79-97d5-502637f829bc" />

In the json output from Gemini, the name is incorrect, so Hermes Chat cannot recognize which plugin it called. (In the input, the name of the weather plugin is `realtime-weather____fetchCurrentWeather`, while Gemini returns `weather____fetchCurrentWeather`).

<Image alt="Tools Calling for Simple Instruction in Gemini 1.5 Pro" src="https://github.com/hermeslabs/hermes-chat/assets/28616219/1e077799-c25e-43c7-8492-c5c0bb9aed9b" />
...
<Image alt="Tools Calling for Complex Instruction in Gemini 1.5 Pro" src="https://github.com/hermeslabs/hermes-chat/assets/28616219/a2454a60-3271-4786-861f-d49ceac1316e" />
...
- [Gemini Models unusable when dalle plugin is enabled](https://github.com/hermeslabs/hermes-chat/issues/2537)
...
<Video src="https://github.com/hermeslabs/hermes-chat/assets/28616219/6cab77e8-d761-4a91-8325-a61748cebac1" />
