...
description: >-
  使用 Hermes Chat 测试 Google Gemini 系列模型（Gemini 1.5 Pro / Gemini 1.5
...
Gemini 输出的 json 中，name 是错误的，因此 Hermes Chat 无法识别到它调用了什么插件。（入参中，天气插件的 name 为 `realtime-weather____fetchCurrentWeather`，而 Gemini 返回的是 `weather____fetchCurrentWeather`）。

<Image alt="Gemini 1.5 Pro 简单指令的 Tools Calling" src="https://github.com/hermeslabs/hermes-chat/assets/28616219/1e077799-c25e-43c7-8492-c5c0bb9aed9b" />
...
<Image alt="Gemini 1.5 Pro 复杂指令的 Tools Calling" src="https://github.com/hermeslabs/hermes-chat/assets/28616219/a2454a60-3271-4786-861f-d49ceac1316e" />
