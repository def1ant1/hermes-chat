---
title: Guide to Using Text-to-Image Models in Hermes Chat
description: >-
  Learn how to utilize text-to-image generation in Hermes Chat using DALL-E and
...
# Guide to Using Text-to-Image Models in Hermes Chat

Hermes Chat supports text-to-image generation through a plugin mechanism. Currently, Hermes Chat comes with the built-in DALL-E plugin, which allows users to generate images using OpenAI's DALL-E model. Additionally, users can also install the official Midjourney plugin to utilize the Midjourney text-to-image feature.
...
Hermes Chat also offers the Midjourney plugin, which generates images by calling the Midjourney API. Please install the Midjourney plugin in the plugin store beforehand.
