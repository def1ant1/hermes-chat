...
description: "了解如何在Hermes Chat中使用支持视觉识别功能的大语言模型，通过上传图片或拖拽图片到输入框进行交互，并选择带有\U0001F441️图标的模型进行图片内容交互。"
tags:
  - 视觉模型
  - 多模态交互
  - 大语言模型
...
当前支持视觉识别的大语言模型生态日益丰富。从 `gpt-4-vision` 开始，Hermes Chat 开始支持各类具有视觉识别能力的大语言模型，这使得 Hermes Chat 具备了多模态交互的能力。
