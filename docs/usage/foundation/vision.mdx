...
description: >-
  Explore how Hermes Chat integrates visual recognition capabilities into large
...
The ecosystem of large language models that support visual recognition is becoming increasingly rich. Starting from `gpt-4-vision`, Hermes Chat now supports various large language models with visual recognition capabilities, enabling Hermes Chat to have multimodal interaction capabilities.
