---
title: Translation of Conversation Records - Hermes Chat
description: >-
  Learn how to translate conversation content in Hermes Chat with just one
  click. Customize translation models for accurate results.
tags:
  - Translation
...
Hermes Chat supports users to translate conversation content into a specified language with just one click. After selecting the target language, Hermes Chat will use a pre-set AI model for translation and display the translated results in real-time in the chat window.
