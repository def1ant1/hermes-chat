...
> 了解更多关于 AI 绘画模态的设计，请参考 [AI 绘画模态设计讨论](https://github.com/hermeslabs/hermes-chat/discussions/7442)
...
大部分 Provider 都使用 `openaiCompatibleFactory` 来兼容 OpenAI，可以通过传入自定义的 `createImage` 函数（参考 [PR #8534](https://github.com/hermeslabs/hermes-chat/pull/8534)）。
...
如果你的 Provider 有独立的类实现，可以直接在类中添加 `createImage` 方法（参考 [PR #8503](https://github.com/hermeslabs/hermes-chat/pull/8503)）。
