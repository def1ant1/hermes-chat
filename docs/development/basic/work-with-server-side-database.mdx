...
Hermes Chat provides a battery-included experience with its client-side database.
...
you can setup all the prerequisites by following the [Deploying Server-Side Database](https://hermes.chat/docs/self-hosting/server-database) story.
...
Launch the Hermes Chat development server:
...
- **PostgreSQL**: `postgres://postgres@localhost:5432/hermes-chat`
