...
> Learn more about the AI image generation modal design in the [AI Image Generation Modal Design Discussion](https://github.com/hermeslabs/lobe-chat/discussions/7442)
...
Most Providers use `openaiCompatibleFactory` for OpenAI compatibility. You can pass in a custom `createImage` function (reference [PR #8534](https://github.com/hermeslabs/lobe-chat/pull/8534)).
...
If your Provider has an independent class implementation, you can directly add the `createImage` method in the class (reference [PR #8503](https://github.com/hermeslabs/lobe-chat/pull/8503)).
