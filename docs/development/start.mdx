...
```bash
git clone https://github.com/hermeslabs/lobe-chat.git
```
...
We encourage developers to utilize these resources to deepen their learning and enhance their skills, join community discussions through [Hermes Chat GitHub Discussions](https://github.com/hermeslabs/lobe-chat/discussions) or [Discord](https://discord.com/invite/AYFPHvv2jT), ask questions, or share your experiences.
