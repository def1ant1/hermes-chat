...
Welcome to the Hermes Chat Technical Development Getting Started Guide. Hermes Chat is an AI conversation application built on the Next.js framework, incorporating a range of technology stacks to achieve diverse functionalities and features. This guide will detail the main technical components of Hermes Chat and how to configure and use these technologies in your development environment.
...
- **Component Library**: We use [Ant Design (antd)](https://ant.design/) as the basic component library, along with [lobe-ui](https://github.com/hermeslabs/lobe-ui) as our business component library.
...
1. **Get the code**: Clone the Hermes Chat code repository locally:
...
Now, you should be able to see the welcome page of Hermes Chat in your browser. For a detailed environment setup guide, please refer to [Development Environment Setup Guide](/docs/development/basic/setup-development).

## Code Style and Contribution Guide

In the Hermes Chat project, we place great emphasis on the quality and consistency of the code. For this reason, we have established a series of code style standards and contribution processes to ensure that every developer can smoothly participate in the project. Here are the code style and contribution guidelines you need to follow as a developer.

- **Code Style**: We use `@hermeslabs/lint` to unify the code style, including ESLint, Prettier, remarklint, and stylelint configurations. Please adhere to our code standards to maintain code consistency and readability.
...
Hermes Chat uses `i18next` and `lobe-i18n` to implement multilingual support, ensuring a global user experience.
...
To support developers in better understanding and using the technology stack of Hermes Chat, we provide a comprehensive list of resources and references — [Hermes Chat Resources and References](/docs/development/basic/resources) - Visit our maintained list of resources, including tutorials, articles, and other useful links.

We encourage developers to utilize these resources to deepen their learning and enhance their skills, join community discussions through [Hermes Chat GitHub Discussions](https://github.com/hermeslabs/hermes-chat/discussions) or [Discord](https://discord.com/invite/AYFPHvv2jT), ask questions, or share your experiences.
