# Hermes Chat - Contributing Guide 🌟

We're thrilled that you want to contribute to Hermes Chat, the future of communication! 😄

Hermes Chat is an open-source project, and we welcome your collaboration. Before you jump in, let's make sure you're all set to contribute effectively and have loads of fun along the way!
...
```bash
git clone https://github.com/YourUsername/hermes-chat.git
```
...
```bash
git remote add upstream https://github.com/hermeslabs/hermes-chat.git
git fetch upstream
git merge upstream/main
```

This ensures you're working on the most current version of Hermes Chat. Stay fresh! 💨

## Open a Pull Request

🚀 Time to share your contribution! Head over to the original Hermes Chat repository and open a Pull Request (PR). Our maintainers will review your work.
...
🎈 Congratulations! Your contribution is now part of Hermes Chat. 🥳

Thank you for making Hermes Chat even more magical. We can't wait to see what you create! 🌠
