...
describe('applyUrlRules', () => {
  ...
  it('github file rules', () => {
    const result = applyUrlRules(
      'https://github.com/hermeslabs/chat-plugin-web-crawler/blob/main/api/v1/_utils.ts',
      [
        {
          filterOptions: {
    ...
    expect(result).toEqual({
      ...
      transformedUrl:
        'https://github.com/hermeslabs/chat-plugin-web-crawler/raw/refs/heads/main/api/v1/_utils.ts',
    });
  });
