...
export const appStorageDir = join(userDataDir, 'hermeslabs-storage');

// ------  Application storage directory ---- //

// db schema hash
export const DB_SCHEMA_HASH_FILENAME = 'hermeslabs-local-db-schema-hash';
// pglite database dir
export const LOCAL_DATABASE_DIR = 'hermeslabs-local-db';
// 本地存储文件（模拟 S3）
