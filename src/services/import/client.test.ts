          ...
          sessions: [
            {
              ...
              meta: {
                avatar: '📝',
                description:
                  'Hermes Chat is an AI conversation application built with the Next.js framework. I will help you write the development documentation for Hermes Chat.',
                tags: [
                ...
                title: 'Hermes Chat Technical Documentation Expert',
              },
              type: 'agent',
