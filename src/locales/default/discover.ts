export default {
  ...
  models: {
    ...
    providerInfo: {
      apiTooltip: 'Hermes Chat 支持为此提供商使用自定义 API 密钥。',
      input: '输入价格',
      ...
      officialTooltip: 'Hermes Labs 官方服务',
      output: '输出价格',
