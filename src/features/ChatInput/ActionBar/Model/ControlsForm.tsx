      ...
      desc: (
        <span style={isNarrow ? descNarrow : descWide}>
          <Trans i18nKey={'extendParams.disableContextCaching.desc'} ns={'chat'}>
            ...
            <Link
              href={'https://www.anthropic.com/news/prompt-caching?utm_source=hermes-chat'}
              rel={'nofollow'}
            >
              了解更多
            </Link>
      ...
      desc: (
        <span style={isNarrow ? descNarrow : descWide}>
          <Trans i18nKey={'extendParams.enableReasoning.desc'} ns={'chat'}>
            ...
            <Link
              href={
                'https://docs.anthropic.com/en/docs/build-with-claude/extended-thinking?utm_source=hermes-chat#why-thinking-blocks-must-be-preserved'
              }
              rel={'nofollow'}
            >
              了解更多
